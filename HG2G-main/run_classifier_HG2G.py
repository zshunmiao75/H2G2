...
#from models.RoBERTa.HG2G_RoBERTa import HG2G_RoBERTa
...
from data_Hgcn import HG2GDataset, HG2GDataloader, HG2GDataset4f1c
...
def main():
    ...
    if args.encoder_type == "BERT":
        ...
        model = HG2G_RoBERTa(config, n_class)
        if args.init_checkpoint is not None:
